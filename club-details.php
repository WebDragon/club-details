...
function register_efmls_club() {
	...
	$clublabels = array(
		...
		'featured_image'		=> __("Club Logo", 'efmls'),
		...
		'remove_featured_image'	=> __("Remove Club Logo image", 'efmls'),
		'search_items'			=> __("Search Clubs", 'efmls'),
		'set_featured_image'	=> __("Set or Upload Club Logo image", 'efmls'),
		'singular_name'			=> __("Club Details", 'efmls'),
		'use_featured_image'	=> __("Use as Logo for this Club", 'efmls'),
...
HTML;
	...
	<div class="club_directory_entry">
		<div class="club_directory_info">
			...
			<h3>{$efmls_general['club_name']} &ndash; <i class="fas fa-map-marker-alt fa-xs"></i> <i>{$region}</i></h3>
